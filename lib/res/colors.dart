...
class MColors {
  ...
  static const primary_color = Color(0xFF9BDCC3);

  static const primary_light_color = const Color(0xff9BDCC3);
  ...
  static const font_color = const Color(0xff777A95);

  static const back_button_color = const Color(0xffA0A2B3);

  static const hint_color = const Color(0xffA0A2B3);
  ...
  static const Color doctor_main_color = Color(0xFF129A7F);
